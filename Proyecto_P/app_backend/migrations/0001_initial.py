# Generated by Django 4.2 on 2024-12-23 17:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Embarcacion',
            fields=[
                ('codigo_embarcacion', models.IntegerField(default=0, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Especie',
            fields=[
                ('codigo_especie', models.IntegerField(default=0, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('especie', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app_backend.especie')),
            ],
        ),
        migrations.CreateModel(
            name='Lance',
            fields=[
                ...
                ('actividad', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_backend.actividadpesquera')),
            ],
        ),
        migrations.CreateModel(
            name='Persona',
            fields=[
                ('codigo_persona', models.IntegerField(default=0, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Puerto',
            fields=[
                ('codigo_puerto', models.IntegerField(default=0, primary_key=True, serialize=False)),
                ('nombre_puerto', models.CharField(default='Sin nombre', max_length=100, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='TipoCarnada',
        ...
        migrations.CreateModel(
            name='Coordenadas',
            fields=[
                ('codigo_lance', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='app_backend.lance')),
                ('latitud_ns', models.CharField(default='N', max_length=1)),
                ('latitud_grados', models.IntegerField(default=0)),
                ('latitud_minutos', models.DecimalField(decimal_places=3, default=0.0, max_digits=10)),
                ('longitud_w', models.CharField(default='W', max_length=1)),
                ('longitud_grados', models.IntegerField(default=0)),
                ('longitud_minutos', models.DecimalField(decimal_places=3, default=0.0, max_digits=10)),
            ],
        ),
        migrations.CreateModel(
            name='IncidenciaAves',
            fields=[
                ('codigo_incidencia', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='app_backend.incidencia')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('codigo_lance', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='app_backend.lance')),
                ('Tipo_anzuelo', models.CharField(default='N', max_length=3)),
        ...
        migrations.AddField(
            ...
            name='lance',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app_backend.lance'),
        ),
        migrations.CreateModel(
            name='DatosCaptura',
            fields=[
                ...
                ('especie', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_backend.especie')),
                ('lance', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_backend.lance')),
            ],
        ),
        migrations.CreateModel(
            name='Avistamiento',
        ...
        migrations.AddField(
            ...
            name='armador',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='armador', to='app_backend.persona'),
        ),
        migrations.AddField(
            model_name='actividadpesquera',
            name='capitan',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='capitan', to='app_backend.persona'),
        ),
        migrations.AddField(
            model_name='actividadpesquera',
            name='embarcacion',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_backend.embarcacion'),
        ),
        migrations.AddField(
            model_name='actividadpesquera',
            name='ingresado',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ingresado', to='app_backend.persona'),
        ),
        migrations.AddField(
            model_name='actividadpesquera',
            name='observador',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='observador', to='app_backend.persona'),
        ),
        migrations.AddField(
            model_name='actividadpesquera',
            name='puerto_entrada',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='entradas', to='app_backend.puerto'),
        ),
        migrations.AddField(
            model_name='actividadpesquera',
            name='puerto_salida',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='salidas', to='app_backend.puerto'),
        ),
        migrations.CreateModel(
            name='LancePalangreCarnadas',
            fields=[
                ('codigo_lance_palangre', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='app_backend.lancepalangre')),
                ('porcentaje_carnada', models.FloatField(default=0.0)),
                ('codigo_tipo_carnada', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_backend.tipocarnada')),
            ],
        ),
    ]
